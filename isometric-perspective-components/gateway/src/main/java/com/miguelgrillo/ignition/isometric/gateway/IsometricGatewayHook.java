...
import com.miguelgrillo.ignition.isometric.common.comp.Custom2DBreakerStandalone;
...
import com.miguelgrillo.ignition.isometric.common.comp.Custom2DDosingValveGauge;
import com.miguelgrillo.ignition.isometric.common.comp.Custom2DDosingValveHalfGauge;
import com.miguelgrillo.ignition.isometric.common.comp.Custom2DGenset2;
...
import com.miguelgrillo.ignition.isometric.common.comp.Custom2DGensetSld;
import com.miguelgrillo.ignition.isometric.common.comp.Custom2DGensetSldS32;
...
import com.miguelgrillo.ignition.isometric.common.comp.Custom2DPump;
import com.miguelgrillo.ignition.isometric.common.comp.Custom2DThreeWayControlValveRev2;
import com.miguelgrillo.ignition.isometric.common.comp.Custom2DTransformer;
...
public class IsometricGatewayHook extends AbstractGatewayModuleHook {
    ...
    public void startup(LicenseState activationState) {
        ...
        this.componentRegistry.registerComponent(Custom2DDosingValveGauge.DESCRIPTOR);
        this.componentRegistry.registerComponent(Custom2DDosingValveHalfGauge.DESCRIPTOR);
        this.componentRegistry.registerComponent(Custom2DGensetSld.DESCRIPTOR);
        this.componentRegistry.registerComponent(Custom2DGenset2.DESCRIPTOR);
        this.componentRegistry.registerComponent(Custom2DGensetSldS32.DESCRIPTOR);
        this.componentRegistry.registerComponent(Custom2DThreeWayControlValveRev2.DESCRIPTOR);
        this.componentRegistry.registerComponent(Custom2DBreakerStandalone.DESCRIPTOR);
        this.componentRegistry.registerComponent(Custom2DPump.DESCRIPTOR);
        this.componentRegistry.registerComponent(Custom2DTransformer.DESCRIPTOR);
    ...
    public void shutdown() {
        ...
        if (this.componentRegistry != null) {
            ...
            this.componentRegistry.removeComponent(Custom2DDosingValveGauge.COMPONENT_ID);
            this.componentRegistry.removeComponent(Custom2DDosingValveHalfGauge.COMPONENT_ID);
            this.componentRegistry.removeComponent(Custom2DGensetSld.COMPONENT_ID);
            this.componentRegistry.removeComponent(Custom2DGenset2.COMPONENT_ID);
            this.componentRegistry.removeComponent(Custom2DGensetSldS32.COMPONENT_ID);
            this.componentRegistry.removeComponent(Custom2DThreeWayControlValveRev2.COMPONENT_ID);
            this.componentRegistry.removeComponent(Custom2DBreakerStandalone.COMPONENT_ID);
            this.componentRegistry.removeComponent(Custom2DPump.COMPONENT_ID);
            this.componentRegistry.removeComponent(Custom2DTransformer.COMPONENT_ID);
