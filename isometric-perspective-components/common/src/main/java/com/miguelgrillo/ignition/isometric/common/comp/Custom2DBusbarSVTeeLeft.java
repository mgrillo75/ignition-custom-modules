...
public final class Custom2DBusbarSVTeeLeft {

    public static final String COMPONENT_ID = "com.miguelgrillo.custom2d.busbar_sv_tee_left";
    ...
    public static final ComponentDescriptor DESCRIPTOR = ComponentDescriptorImpl.ComponentBuilder.newBuilder()
        ...
        .setSchema(SCHEMA)
        .setName("Busbar SV Tee Left")
        .addPaletteEntry("", "Busbar SV Tee Left", "Segmented-vertical style busbar tee connector (left).", null, null)
        .setDefaultMetaName("busbarSVTeeLeft2d")
        .setResources(IsometricComponents.BROWSER_RESOURCES)
        .build();

    private Custom2DBusbarSVTeeLeft() {
    }
}