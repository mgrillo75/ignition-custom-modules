...
public final class Custom2DBusbarHTeeRight {

    public static final String COMPONENT_ID = "com.miguelgrillo.custom2d.busbar_h_tee_right";
    ...
    public static final ComponentDescriptor DESCRIPTOR = ComponentDescriptorImpl.ComponentBuilder.newBuilder()
        ...
        .setSchema(SCHEMA)
        .setName("Busbar H Tee Right")
        .addPaletteEntry("", "Busbar H Tee Right", "Horizontal-style busbar tee connector (right).", null, null)
        .setDefaultMetaName("busbarHTeeRight2d")
        .setResources(IsometricComponents.BROWSER_RESOURCES)
        .build();

    private Custom2DBusbarHTeeRight() {
    }
}