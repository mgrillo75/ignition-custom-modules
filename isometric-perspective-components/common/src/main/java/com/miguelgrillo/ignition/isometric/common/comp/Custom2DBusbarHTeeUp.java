...
public final class Custom2DBusbarHTeeUp {

    public static final String COMPONENT_ID = "com.miguelgrillo.custom2d.busbar_h_tee_up";
    ...
    public static final ComponentDescriptor DESCRIPTOR = ComponentDescriptorImpl.ComponentBuilder.newBuilder()
        ...
        .setSchema(SCHEMA)
        .setName("Busbar H Tee Up")
        .addPaletteEntry("", "Busbar H Tee Up", "Horizontal-style busbar tee connector (up).", null, null)
        .setDefaultMetaName("busbarHTeeUp2d")
        .setResources(IsometricComponents.BROWSER_RESOURCES)
        .build();

    private Custom2DBusbarHTeeUp() {
    }
}