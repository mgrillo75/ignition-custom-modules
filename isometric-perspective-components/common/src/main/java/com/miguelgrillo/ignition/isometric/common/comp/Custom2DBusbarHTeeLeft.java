...
public final class Custom2DBusbarHTeeLeft {

    public static final String COMPONENT_ID = "com.miguelgrillo.custom2d.busbar_h_tee_left";
    ...
    public static final ComponentDescriptor DESCRIPTOR = ComponentDescriptorImpl.ComponentBuilder.newBuilder()
        ...
        .setSchema(SCHEMA)
        .setName("Busbar H Tee Left")
        .addPaletteEntry("", "Busbar H Tee Left", "Horizontal-style busbar tee connector (left).", null, null)
        .setDefaultMetaName("busbarHTeeLeft2d")
        .setResources(IsometricComponents.BROWSER_RESOURCES)
        .build();

    private Custom2DBusbarHTeeLeft() {
    }
}