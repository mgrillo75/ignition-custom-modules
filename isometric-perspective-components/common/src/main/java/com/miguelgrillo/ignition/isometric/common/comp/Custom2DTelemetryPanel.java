...
public final class Custom2DTelemetryPanel {

    public static final String COMPONENT_ID = "com.miguelgrillo.custom2d.telemetry_panel";
    ...
    public static final ComponentDescriptor DESCRIPTOR = ComponentDescriptorImpl.ComponentBuilder.newBuilder()
        ...
        .setSchema(SCHEMA)
        .setName("Telemetry Panel")
        .addPaletteEntry("", "Telemetry Panel", "Telemetry panel SVG with bindable color/text overrides.", null, null)
        .setDefaultMetaName("telemetryPanel2d")
        .setResources(IsometricComponents.BROWSER_RESOURCES)
        .build();

    private Custom2DTelemetryPanel() {
    }
}
