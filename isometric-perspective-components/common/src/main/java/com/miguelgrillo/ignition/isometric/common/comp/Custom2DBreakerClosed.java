...
public final class Custom2DBreakerClosed {

    public static final String COMPONENT_ID = "com.miguelgrillo.custom2d.breaker_closed";
    ...
    public static final ComponentDescriptor DESCRIPTOR = ComponentDescriptorImpl.ComponentBuilder.newBuilder()
        ...
        .setSchema(SCHEMA)
        .setName("Breaker Closed")
        .addPaletteEntry("", "Breaker Closed", "Closed breaker SVG with bindable color/text overrides.", null, null)
        .setDefaultMetaName("breakerClosed2d")
        .setResources(IsometricComponents.BROWSER_RESOURCES)
        .build();

    private Custom2DBreakerClosed() {
    }
}
