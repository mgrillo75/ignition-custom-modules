...
public final class Custom2DBusbarSVTeeRight {

    public static final String COMPONENT_ID = "com.miguelgrillo.custom2d.busbar_sv_tee_right";
    ...
    public static final ComponentDescriptor DESCRIPTOR = ComponentDescriptorImpl.ComponentBuilder.newBuilder()
        ...
        .setSchema(SCHEMA)
        .setName("Busbar SV Tee Right")
        .addPaletteEntry("", "Busbar SV Tee Right", "Segmented-vertical style busbar tee connector (right).", null, null)
        .setDefaultMetaName("busbarSVTeeRight2d")
        .setResources(IsometricComponents.BROWSER_RESOURCES)
        .build();

    private Custom2DBusbarSVTeeRight() {
    }
}