...
public final class Custom2DBusbarSVTeeUp {

    public static final String COMPONENT_ID = "com.miguelgrillo.custom2d.busbar_sv_tee_up";
    ...
    public static final ComponentDescriptor DESCRIPTOR = ComponentDescriptorImpl.ComponentBuilder.newBuilder()
        ...
        .setSchema(SCHEMA)
        .setName("Busbar SV Tee Up")
        .addPaletteEntry("", "Busbar SV Tee Up", "Segmented-vertical style busbar tee connector (up).", null, null)
        .setDefaultMetaName("busbarSVTeeUp2d")
        .setResources(IsometricComponents.BROWSER_RESOURCES)
        .build();

    private Custom2DBusbarSVTeeUp() {
    }
}