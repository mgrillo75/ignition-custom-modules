...
public final class Custom2DControlValveModern {

    public static final String COMPONENT_ID = "com.miguelgrillo.custom2d.control_valve_modern";
    ...
    public static final ComponentDescriptor DESCRIPTOR = ComponentDescriptorImpl.ComponentBuilder.newBuilder()
        ...
        .setSchema(SCHEMA)
        .setName("Control Valve Modern")
        .addPaletteEntry("", "Control Valve Modern", "Modern control valve SVG with bindable color/text overrides.", null, null)
        .setDefaultMetaName("controlValveModern2d")
        .setResources(IsometricComponents.BROWSER_RESOURCES)
        .build();

    private Custom2DControlValveModern() {
    }
}
