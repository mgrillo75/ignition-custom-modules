...
public final class Custom2DGensetSync {

    public static final String COMPONENT_ID = "com.miguelgrillo.custom2d.genset_sync";
    ...
    public static final ComponentDescriptor DESCRIPTOR = ComponentDescriptorImpl.ComponentBuilder.newBuilder()
        ...
        .setSchema(SCHEMA)
        .setName("Genset Sync")
        .addPaletteEntry("", "Genset Sync", "Genset sync symbol SVG with bindable color/text overrides.", null, null)
        .setDefaultMetaName("gensetSync2d")
        .setResources(IsometricComponents.BROWSER_RESOURCES)
        .build();

    private Custom2DGensetSync() {
    }
}
