...
public final class Custom2DTransformer {

    public static final String COMPONENT_ID = "com.miguelgrillo.custom2d.transformer";
    ...
    public static final ComponentDescriptor DESCRIPTOR = ComponentDescriptorImpl.ComponentBuilder.newBuilder()
        ...
        .setSchema(SCHEMA)
        .setName("Transformer")
        .addPaletteEntry("", "Transformer", "Transformer SVG with bindable line and glow controls.", null, null)
        .setDefaultMetaName("transformer2d")
        .setResources(IsometricComponents.BROWSER_RESOURCES)
        .build();

    private Custom2DTransformer() {
    }
}
