...
public final class Custom2DGensetOpen {

    public static final String COMPONENT_ID = "com.miguelgrillo.custom2d.genset_open";
    ...
    public static final ComponentDescriptor DESCRIPTOR = ComponentDescriptorImpl.ComponentBuilder.newBuilder()
        ...
        .setSchema(SCHEMA)
        .setName("Genset Open")
        .addPaletteEntry("", "Genset Open", "Genset open symbol SVG with bindable color/text overrides.", null, null)
        .setDefaultMetaName("gensetOpen2d")
        .setResources(IsometricComponents.BROWSER_RESOURCES)
        .build();

    private Custom2DGensetOpen() {
    }
}
