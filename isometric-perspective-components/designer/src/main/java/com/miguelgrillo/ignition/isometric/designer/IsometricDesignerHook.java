...
public class IsometricDesignerHook extends AbstractDesignerModuleHook {
    ...
    public void startup(DesignerContext context, LicenseState activationState) {
        ...
        this.registry.registerComponent(Custom2DDosingValveGauge.DESCRIPTOR);
        this.registry.registerComponent(Custom2DDosingValveHalfGauge.DESCRIPTOR);
        this.registry.registerComponent(Custom2DGensetSld.DESCRIPTOR);
        this.registry.registerComponent(Custom2DGenset2.DESCRIPTOR);
        this.registry.registerComponent(Custom2DGensetSldS32.DESCRIPTOR);
        this.registry.registerComponent(Custom2DThreeWayControlValveRev2.DESCRIPTOR);
        this.registry.registerComponent(Custom2DBreakerStandalone.DESCRIPTOR);
        this.registry.registerComponent(Custom2DPump.DESCRIPTOR);
        this.registry.registerComponent(Custom2DTransformer.DESCRIPTOR);
    ...
    public void shutdown() {
        if (this.registry != null) {
            ...
            this.registry.removeComponent(Custom2DDosingValveGauge.COMPONENT_ID);
            this.registry.removeComponent(Custom2DDosingValveHalfGauge.COMPONENT_ID);
            this.registry.removeComponent(Custom2DGensetSld.COMPONENT_ID);
            this.registry.removeComponent(Custom2DGenset2.COMPONENT_ID);
            this.registry.removeComponent(Custom2DGensetSldS32.COMPONENT_ID);
            this.registry.removeComponent(Custom2DThreeWayControlValveRev2.COMPONENT_ID);
            this.registry.removeComponent(Custom2DBreakerStandalone.COMPONENT_ID);
            this.registry.removeComponent(Custom2DPump.COMPONENT_ID);
            this.registry.removeComponent(Custom2DTransformer.COMPONENT_ID);
